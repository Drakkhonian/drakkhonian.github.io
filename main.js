...
for (let family_index = 0; family_index < primaries.length; family_index++) {
    ...
    var family_area = document.createElement('div');
    ...
    var family_title = document.createElement('div');
    ...
    var family_boxes = document.createElement('div');
    ...
    for (let material_index = 0; material_index < family_element.length; material_index++) {
        ...
        material_checkbox.checked = "checked";
